...
public class WifiModule {
    ...
    public WifiModule(Context context) {
        ...
        mMySSID = "shw" + InfoUtil.getName(context);
    }
    ...
    public WifiConfiguration CreateWifiInfo(String SSID, String Password, int Type) {
        ...
        //断开之前的连接
        WifiConfiguration tempConfig = findExistsWifiConfiguration(SSID);
        if (tempConfig != null) {
    ...
    public void connect(final String ssid, final OnProcessCallBack callBack) {
        ...
        int wcgID = mWifiManager.addNetwork(CreateWifiInfo(ssid, "", 1));
